...
const topPicksConfig = {
  recruiter: [
    { title: "Career Goals", imgSrc: "https://picsum.photos/seed/workpermit/250/200", icon: <FaPassport />, route: "/career-goals" },
  ...
  adventure: [
    ...
    { title: "Motivation & Mindset", imgSrc: require("../images/motivation_mindset_thumb.png"), route: "/reading", icon: <FaBook /> },
    { title: "Contact Me", imgSrc: "https://picsum.photos/seed/connect/250/200", route: "/contact-me", icon: <FaEnvelope /> },
